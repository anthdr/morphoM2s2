...
for train_index, test_index in kfold.split(X, y):
    ...
    training_generator = BalancedBatchGenerator(X, y, sampler=NearMiss(), batch_size=32, random_state=42)
    model.fit_generator(generator=training_generator, epochs=64, verbose=1)
